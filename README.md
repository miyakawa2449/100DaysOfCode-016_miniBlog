...
**主要特徴**:
- ✍️ **Markdownエディター**: リアルタイムプレビュー付き高機能エディター
- 🖼️ **画像管理システム**: アップロード、管理、検索機能を統合
...
- **画像挿入**: ドラッグ&ドロップまたはクリップボード貼り付け
- **テーブル・リスト**: 拡張Markdown記法対応
- **ツールバー**: よく使う書式をボタンで挿入

### **画像管理**
- **🌟 アイキャッチ画像**: 1.91:1比率（1200×630px）OGP対応自動クロッピング
- **📸 記事内画像**: 複数画像の一括アップロード
- **🔍 画像検索**: ファイル名、Alt属性、キャプションで検索
- **📊 使用状況**: 各画像の使用回数を追跡
- **✏️ メタデータ編集**: Alt属性、キャプション、説明を管理
- **✂️ トリミング機能**: Cropper.js による高度な画像編集
- **🔧 自動最適化**: アップロード時の画像サイズ最適化
- **🗑️ 削除管理**: アイキャッチ・カテゴリ画像の安全な削除機能
- **🖼️ サムネイル表示**: 整理された画像一覧とプレビュー

### **高度な機能**
- **📱 SNS埋め込み**: X(Twitter), Facebook, Instagram, YouTube対応
- **🔄 表示モード切替**: 埋込 vs OGPカード表示
- **🤖 自動プラットフォーム検出**: SNS URL解析と最適な表示形式の選択
- **🔗 外部記事連携**: OGPデータ自動取得とプレビューカード生成
